              ...
              >
                ...
                <div className={`p-5 rounded-2xl border bg-gradient-to-br ${getStatusColor(result.status)} shadow-sm`}>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-baseline">
                      <span className="text-xs opacity-80">Moyenne locale :</span>
                  ...
                  <p className="text-[10px] opacity-50 mt-3 italic">Calculé sur {result.transaction_count} transactions réelles dans le secteur.</p>
                </div>
                ...
                <div className="border border-slate-200 bg-slate-50 rounded-xl p-4 space-y-3">
                  ...
                  <div className="text-xs space-y-2">
                    ...
                    {result.dpe.avg_conso && (
                      <div className="flex justify-between">
                        <span className="text-slate-500">Consommation moyenne locale :</span>
